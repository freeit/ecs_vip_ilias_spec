...
\begin{itemize}
  ...
  \item Beim Starten des Applets werden folgende Parameter mitgegeben:\par
      ECS-URL, EcsAuthId, Ilias mid, Computation-Backend mid,
      Exercise-Ressourcen-Name exres, Solution-Ressourcen-Name solres,
      Result-Ressourcen-Name resres, Exercise-ID exid 
